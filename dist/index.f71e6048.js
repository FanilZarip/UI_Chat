...
parcelHelpers.export(exports, "authorizationEmail", ()=>authorizationEmail
);
...
const authorizationEmail = function getAuthorizationEmail() {
    const authorizationEmail1 = {
...
const socket = new _reconnectingWebsocketDefault.default(_serviceJs.Rest_API_Data.webSocket);
